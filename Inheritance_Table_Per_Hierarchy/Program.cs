...
//Öncelikle hiyerarşinin başında yani Person  hangi sınıf varsa onun Fluent API'da konfigürasyonuna gidilmeli.
...
// Empleye eklediğim için ayırıcı kolona "B" Yazacak
//Employee employee = new Employee() { Name = "Furkan", Surname = "Demirbozan" };  
...
//Böyle ilişkisel kalıtımda Default olarak TPH Table Per Hierarchy olur 
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        //    .HasDiscriminator<string>("ayirici")   //Ayırıcı kolon burası
        //    .HasValue<Person>("A")
        //    .HasValue<Employee>("B")
        //    .HasValue<Customer>("C")
    ...
    {
        optionsBuilder.UseSqlServer("Server=DESKTOP-OSM1H58\\SQLEXPRESS;Database=TablePerHierarchy;User ID=sa;Password=123456;TrustServerCertificate=True");
    }
}
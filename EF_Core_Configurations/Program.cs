...
#endregion
//Yapılandıma diyince akla gelen ilk metotdur
//Bu metot DbContex Sınıfı içerisinde virtal olarak ayarlanmıştır
//bizler bu metotu kullanarak model lerimizle ilgili temel konfigurasyonel davranışları (fluent api) sergileyebiliyoruz
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        #endregion
        #region ToTable
        //Generate edilecek tablonun ismini belirleriz
        //EfCore normal şartlarda Generate edileceği tablonun adını DbSet Property sinden almaktadır.Bizler eğer ki bunu özerlleştirmek istiyorsak Table Table Atribute unu yada ToTable api sini kullanabiliriz
        ...
        #endregion
        #region Column- HasColumnName, HasColumnType,HasColumnOrder
        //EfCore da tablonun kolonkarı entity sınıfları içerisindeki proplara karşılık gelmektedir
        //Default olarak prop ların adı kolon adıyke türleri/Tipleri kolon türündedir
        ...
        //    .IsConcurrencyToken();
        #endregion
        #region CompositeKey Birden fazla PK yapma
        //modelBuilder.Entity<Person>().HasKey("Id", "Id2");   ////Ya böyle olacak
        //Yada
        //modelBuilder.Entity<Person>().HasKey(p => new { p.Id, p.Id2 });
        #endregion
        #region HasDefaultSchema
        //modelBuilder.HasDefaultSchema("ahmet");  ///Dbo yu ezdim
        #endregion
        #region Property
        #region HasDefaultValue
        //modelBuilder.Entity<Person>()
        ...
        #endregion
        #region HasData
        //Seed data ile migragate sürecinde oluşturulacak verilere PK olan ID kolonlara kendimiz girmek zorundayız

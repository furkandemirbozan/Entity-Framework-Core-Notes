...
//Computed demek yani default gibi bişey
#endregion
...
class Person
{
    //[DatabaseGenerated(DatabaseGeneratedOption.None)] //  PK özelliğini kaldırdım
    ...
    //[DatabaseGenerated(DatabaseGeneratedOption.Identity)] //PK özellii verdim ancak burada türü int olmadığı için İdentity sıfır olarak atar
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>()
            ...
            .ValueGeneratedOnAddOrUpdate();//Computed (default)column olduğunu belirtmiş olurum belirtmesemde olur.Çokta önemli değiş
        ...
        modelBuilder.Entity<Person>()
            .Property(p => p.PersonCode)
            .ValueGeneratedOnAdd();//identity olduğunu böyle belirttim
    }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer("Server=DESKTOP-OSM1H58\\SQLEXPRESS;Database=GencayYıldızDB ;User ID=sa;Password=123456;TrustServerCertificate=True");
    }
}